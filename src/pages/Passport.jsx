      ...
      <div className="card" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.3rem', fontWeight: 800, color: 'var(--text-dark)', margin: 0 }}>RetinaGuard Health Passport</h3>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.75rem', color: 'var(--text-light)' }}>RetinaGuard AI v1.0 • Clinical Protocol Standard</span>
        </div>
      </div>
    </div>
  );
